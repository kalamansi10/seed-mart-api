Rails.application.routes.draw do
  ...
  concern :user_actions do
    ...
    post "/add-shipping-address", to: "cart#add_shipping_addresses"
    post "/update-shipping-address", to: "cart#update_shipping_address"
    delete "/remove-shipping-address/:shipping_address_id", to: "cart#remove_shipping_address"

    get "/get-payment-methods", to: "user#get_payment_methods"
    post "/add-payment-method", to: "cart#add_payment_method"
    post "/update-payment-method", to: "cart#update_payment_method"
    delete "/remove-payment-method/:payment_method_id", to: "cart#remove_payment_method"
